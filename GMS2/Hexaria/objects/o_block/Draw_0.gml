if o_pause.paused == false
{
 ...
 if active = true
 {
  ...
  draw_sprite_ext(sprite_index,color_index+1,x,y,1,1,0,-1,1)
  if locked == true 
  {
	  draw_sprite(s_lock,global.coloricon,x,y)
	}
  if global.coloricon == 1  
  {
	  draw_sprite_ext(s_colorblind,color_index,x+3,y+15,1,1,0,c_white,0.75)
	}
 ...
 {
  draw_sprite_ext(sprite_index,color_index+1,x,y,1,1,0,-1,0.75)
