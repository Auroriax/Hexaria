...
"
Normaal
Drie minuten, drie kleuren
Moeilijk
Vier minuten, vier kleuren
Expert
Vijf minuten, vijf kleuren
Zen
Relax en krijg motivatie in deze eindeloze spelmodus
Muziek
Stilte of meesleping
SFX
...
[Enter] Stuur score - [Esc] Overslaan
Score aan het verzenden...
Score verzonden. Highscorelijsten aan het ophalen...
Kon highscore niet verzenden.
Highscorelijsten voor deze modus:
...
Ontstaan
Een kristallen toren groeit tot ver in de lucht...##Voorkom dat de toren te hoog komt!
Gebruiker
Score
Ingestuurd
Opnieuw
Tweeten
Log in op GameJolt om trofeeën te verdienen en scores in te zenden
(Stap 1/2) Voer alsjeblieft je GameJolt-gebruikersnaam in:
(Stap 2/2) Voer alsjeblieft je GameJolt-usertoken in:
Inloggen mislukt. Reden:
Succesvol ingelogd als
Je bent momenteel ingelogd,
Wil je nu uitloggen?
Succesvol uitgelogd.
Verwijder alle vrijgespeelde modi en zet het spel terug naar de oorspronkelijke instellingen?
Wereldwijde statistieken voor deze modus:
gespeelde potjes
totale score
geldige zetten
edelstenen weggespeeld
Een nieuwe versie van Hexaria (V
) is nu beschikbaar.
...
"
Normal
Three minutes, with three colors
Hard
Four minutes, four colors
Expert
Five minutes, with five colors
Zen
Relax and get motivated in this endless game mode
Music
Silence or immersion
Sounds
...
[Enter] Submit score - [Esc] Skip
Submitting your score...
Score sent. Fetching leaderboards...
Failed to submit highscore.
Leaderboards for this mode:
...
Arise
A crystal tower rises to the sky...##Prevent it from reaching too high!
User
Score
Submittance
Retry
Tweet
Log in to GameJolt to earn trophies and submit scores
(Step 1/2) Please enter your GameJolt username:
(Step 2/2) Please enter your GameJolt usertoken:
Failed to log in. Reason:
Successfully logged in as
You're currently logged in,
Would you like to log out?
Successfully logged out.
Delete unlocked modes and go back to initial settings?
Worldwide statistics for this mode:
games played
total score
valid matches
gems removed
A new version of Hexaria (V
) is now available.
